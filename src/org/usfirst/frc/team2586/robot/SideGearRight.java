...
public class SideGearRight extends Command {
	...
	public SideGearRight(RobotDrive drive, Gyro theGyro, Encoder encoderFR, Encoder encoderFL, Encoder encoderRR, Encoder encoderRL, Solenoid gearPopOut, Solenoid gearPopIn) {
		// name thy talons
		loveDrive = drive;
		myGyro = theGyro;
