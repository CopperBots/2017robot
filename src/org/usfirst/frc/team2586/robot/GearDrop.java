...
public class GearDrop extends Command {
	...
	public GearDrop(CANTalon frontRightDrive2, CANTalon frontLeftDrive2, CANTalon rearLeftDrive2, CANTalon rearRightDrive2, Talon gearDrop) {
		// name thy talons
